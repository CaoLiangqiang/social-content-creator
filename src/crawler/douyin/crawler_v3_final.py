...
class DouyinVideoCrawlerV3:
    ...
    def crawl_video_by_url(self, url: str) -> Optional[DouyinVideoItem]:
        ...
        try:
            ...
            router_data = self._extract_router_data(soup)
    ...
    def _extract_router_data(self, soup: BeautifulSoup) -> Optional[Dict]:
        """从BeautifulSoup对象提取ROUTER_DATA"""
